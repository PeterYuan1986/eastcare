...
$sql = "SELECT doctor_id, name FROM doctor where  name LIKE '%" . @$_SESSION['detailpagesearchtext'] . "%' or  doctor_id LIKE '%" . @$_SESSION['detailpagesearchtext'] . "%'";
...
for ($i = 0; $i < $perpage; $i++) {
    ...
    if ($i > @count($data)) {
        ...
        $_SESSION['doctor_id'] = $data[$ind]['doctor_id'];
        $sql = "select * from doctor where  doctor_id='" . $_SESSION['doctor_id'] . "'";
        $result = mysqli_query($conn, $sql);
        $row = mysqli_fetch_array($result);
        $_SESSION['detaildoctorname'] = $row[1];
        $_SESSION['detaildoctorbirth'] = $row[2];
        $_SESSION['detaildoctorgender'] = $row[3];
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <div class="breadcomb-wp">
                                                ...
                                                <div class="breadcomb-ctn">
                                                    <h2>Doctor Detail</h2>
                                                    <p>Welcome to East Care System <span class="bread-ntd"></span></p>
                                ...
                                <div class="col-lg-5 col-md-7 col-sm-7 col-xs-12">
                                    <div class="single-product-details res-pro-tb">
                                        <div class="single-pro-price">
                                            <span class="single-regular"><?php print "Doctor ID" . @$_SESSION['patientid']; ?></span>
                                        </div>                                        
...
<!--    
        ...
        $_SESSION['detailpatientphone'] = $row[11];-->
                                        ...
                                        <div class="color-quality-pro">
                                            <div class="color-quality-details">
                                                <h5>Private Address:</h5>
                                                 <h5 style="color:#fff" ><?php print @$_SESSION['detailpatientaddress'].' '.@$_SESSION['detailpatientaddress2'].','.@$_SESSION['detailpatientcity'].','
                                                         .@$_SESSION['detailpatientstate'].' '.@$_SESSION['detailpatientzipcode']; ?></h5>                                                
                                        ...
                                        <div >
                                            ...
                                            <div >
                                                <?php  if(@$_SESSION['detailpatientinhospital']=='N'){
                                                    $ssss='admit.php';
                                                }  else{
                                                     $ssss='release.php';
                                                }  ?>
                                                <a  href="#" onclick="openNewWin(<?php print "'".$ssss."'";?>);">
