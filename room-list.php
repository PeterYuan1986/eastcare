...
if (!isset($_SESSION['room-list_searchtext'])) {
    $_SESSION['room-list_searchtext'] = '';
}
...
for ($i = 0; $i < @count(@$data); $i++) {
    ...
    if (isset($_REQUEST["{$tem}"])) {
        $_REQUEST["{$tem}"] = 0;
        $sql = "DELETE FROM `roomtype` WHERE room_number='" . $data[$i]['room_number'] . "'";
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="product-status-wrap">
                    ...
                    <div class="add-product" >                                    
                        ...
                        <a  href="room-edit.php">Add Room</a>
                    </div>
                    <div>
                            ...
                            <div class="header-top-menu tabl-d-n">
                                <div class="breadcome-heading">
                                    <form method="post" role="search" class="">
                                        ...
                                        <div style="width:200px;float:left;"><input name="searchtext" type="text" placeholder="Search room number....." value="<?php
                                            if (isset($_SESSION['room-list_searchtext'])) {
                                                print $_SESSION['room-list_searchtext'];
                                            }
                                            ?>" ></div>
